...
selain itu jika parameter number lebih besar sama dengan 60 dan lebih kecil dari 70 maka akan mereturn string “Cukup” selain itu maka akan mereturn string “Kurang”
*/
...
echo tentukan_nilai(95) . "<br>"; //Sangat Baik
echo tentukan_nilai(75) . "<br>"; //Baik
echo tentukan_nilai(65) . "<br>"; //Cukup
echo tentukan_nilai(45); //Kurang
